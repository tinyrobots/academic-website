...
matched human perception for specific stimulus sequences. Nine observers viewed triads of images from five
sequences in a Maximum Likelihood Difference Scaling experiment. Gloss values within the unsupervised
model better predicted human perceptual gloss scales than did pixelwise differences between images (_p_=
0.042). Unsupervised machine learning may hold the key to fully explicit, image-computable models of how we
learn meaningful perceptual dimensions from natural data."
