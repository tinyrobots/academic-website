...
date_end = 2019-08-13T12:30:00
all_day = false

# Location of event.
location = "SFB Symposium: How Humans and Machines Learn to See, Rauischholzhausen Castle, Germany"

# Name of event and optional event URL.
event = "Symposium Talk"
event_url = ""

# Abstract. What's your talk about?
abstract = "Presenting new results from two projects using unsupervised deep neural networks to learn about image structure from static or moving visual input. Such networks spontaneously learn to represent underlying scene factors, and can predict human gloss perception and misperception on an image-by-image basis."
